			...
			<div class="col-md-6">
				<div class="card paint-card">
					<div class="card-body">
						...
						<form class="row g-3" action="controller?action=appointmentServlet" method="post">
							...
							<div class="col-md-6">
								<label for="inputPassword4" class="form-label">Doctor</label> <select
									required class="form-control" name="docName">
									<%-- <option value="">--select--</option>

									<%
									DoctorDao dao = new DoctorDao(MongoClient mongo);
									...
									%>
									<option value="<%=doctor.getFullName()%>">
