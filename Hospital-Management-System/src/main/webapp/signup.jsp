...
<body>
	...
	<!-- <button onclick="goBack()" class="btn btn-secondary bg-info">Back</button>
				...
				<div class="card paint-card">
					<div class="card-body">
						...
						<c:if test="${not empty sucMsg }">
							...
							<meta http-equiv="refresh" content="10; url=./user_login.jsp">
						</c:if>
						...
						<form action="controller?action=user_register" method="post">
							<div class="mb-3">
							...
							<div class="mb-3">
								<label class="form-label">Postal Code</label> <input required
									name="postalCode" type="text" class="form-control">
							</div>
