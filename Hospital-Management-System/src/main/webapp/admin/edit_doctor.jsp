		...
		<div class="row">
			...
			<div class="col-md-4 offset-md-4">
				<div class="card paint-card">
                    ...
                    List<Doctor> list = dao.getList();
                    /* List<Doctor> list = dao.getDocData(id); */
                    for (Doctor d : list) {
           				if(d.getFullName().equalsIgnoreCase(request.getParameter("_id"))) {
                    %>
						...
						<form action="../updateDoctor" method="post">
							...
							<div class="mb-3">
								<label class="form-label">Mob No</label> <input type="text"
									value="<%=d.getMob()%>" required name="mob"
									class="form-control">
							</div>
